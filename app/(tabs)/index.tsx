...
export default function DialerScreen() {
  ...
  const [isCameraActive, setIsCameraActive] = useState(true); // Always active for hand detection
  ...
  const handleManualVoiceToggle = () => {
    ...
    if (!isVoiceActive && isGestureActive) setIsGestureActive(false);
  };
      ...
      <View style={styles.topControls}>
        <View style={styles.controlGroup}>
          ...
          <Text style={[styles.controlLabel, { color: colors.text }]}>
            {isGestureActive ? 'Gestures Active' : 'Manual Gestures'}
          </Text>
        </View>
        ...
        <View style={styles.controlGroup}>
          ...
          <Text style={[styles.controlLabel, { color: colors.text }]}>
            {isVoiceActive ? 'Voice Active' : 'Say "Start Call"'}
          </Text>
        </View>
      </View>
